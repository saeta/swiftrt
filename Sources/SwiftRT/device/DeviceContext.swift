...
//    //--------------------------------------------------------------------------
//    /// hostCoherent
//    public static var hostCoherent: ComputeDevice {
//        return DeviceContext.current[0].memoryAddressing == .unified ?
//            DeviceContext.current[0] :
//            Platform.local.services[cpuService]!.devices[0]
//    }
//
//    //--------------------------------------------------------------------------
//    /// auxHostQueue
...
//    public var logInfo: LogInfo { return devicesStack.last!.logInfo }
//
//    //--------------------------------------------------------------------------
//    /// updateDefault
//    public func updateDefault(queue: DeviceQueue) {
//        devicesStack[0] = queue
//    }
//
//    //--------------------------------------------------------------------------
//    // initializers
